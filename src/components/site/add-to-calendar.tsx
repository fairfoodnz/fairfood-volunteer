  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="min-w-[14rem]">
        {/*
          Base UI's GroupLabel must live inside a Group (it reads the group
          context for aria-labelledby) — a bare DropdownMenuLabel throws
          Base UI error #31 at runtime. Wrap the label and the destinations
          it heads in a single group.
        */}
        <DropdownMenuGroup>

...
export default function VerifyEmail({
  ...
  return (
    <Html lang="en" dir="ltr">
      ...
      <Preview>{`Confirm your email to finish setting up your ${org.name} account`}</Preview>
      <Tailwind>
        <Body
        ...
        >
          ...
          >
            ...
            <Text className={text}>
              Welcome to the kai table! Just one quick step — confirm this is
              your email so we can send you shift reminders and roster updates.
              Once you&apos;re verified you can book your first shift.
            </Text>
            ...
            >
              <Link href={verifyUrl} className={`text-[${brand.leafDeep}] underline`}>
                {verifyUrl}
              </Link>
            </Text>
            ...
            <Text className={text}>
              ...
              create a {org.name} account, you can safely ignore this email —
...
VerifyEmail.PreviewProps = {
  verifyUrl: "https://volunteer.fairfood.org.nz/auth/verify-email?token=abc123",
  userName: "Aroha",
  expiresInHours: 24,
